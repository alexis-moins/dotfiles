...
hi(0, "GitSignsStagedAdd", { fg = "#536d4a" })
hi(0, "GitSignsStagedAddLn", { bg = "#3b474a" })
hi(0, "GitSignsStagedAddNr", { fg = "#536d4a" })
hi(0, "GitSignsStagedChange", { fg = "#776a4f" })
hi(0, "GitSignsStagedChangeLn", { bg = "#2b3047" })
hi(0, "GitSignsStagedChangeNr", { fg = "#776a4f" })
hi(0, "GitSignsStagedChangedelete", { fg = "#776a4f" })
hi(0, "GitSignsStagedChangedeleteLn", { bg = "#2b3047" })
hi(0, "GitSignsStagedChangedeleteNr", { fg = "#776a4f" })
hi(0, "GitSignsStagedDelete", { fg = "#76434b" })
hi(0, "GitSignsStagedDeleteNr", { fg = "#76434b" })
hi(0, "GitSignsStagedTopdelete", { fg = "#76434b" })
hi(0, "GitSignsStagedTopdeleteNr", { fg = "#76434b" })
...
hi(0, "MiniClueNextKey", { fg = "#c6a0f6" })
hi(0, "MiniClueNextKeyWithPostKeys", { fg = "#c6a0f6" })
hi(0, "MiniClueSeparator", { fg = "#24273a" })
hi(0, "MiniFilesBorderModified", { fg = "#ed8796" })
hi(0, "MiniIndentscopeSymbol", { link = "LineNr" })
