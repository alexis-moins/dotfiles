...
map('n', '<Leader>sl', function() _G.MiniSessions.write("Session.vim") end, "Write a local session")

map('n', '<Leader>sr', function() _G.MiniSessions.select "read" end, "Read a session")

map('n', '<Leader>sd', function() _G.MiniSessions.select "delete" end, "Delete a session")
